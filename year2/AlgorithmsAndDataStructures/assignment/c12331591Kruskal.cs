    ...
    **********************************************************/
    ...
    private int partition(Edge[] a, int l, int r)//component of quicksort
    {
        ...
        while (true)
        {
            ...
            do { --j; } while (a[j] > pivot);//> and <= work with edges thanks to operator overloading
            ...
            temp = a[i];//swapping the pivot value
            a[i] = a[j];
            a[j] = temp;
        }
    ...
    public static int Main()
    {
        ...
        Console.ReadKey();//keeping the window open if the program isn't opened from the console
